		...
		<div>
			<div className="row d-flex justify-content-center mt-5 mb-5 pb-5">
				<div className="col-lg-3 col-sm-12" id="header">
					...
					<p id="header-bio">
						Recent graduate of DU Full Stack Dev Bootcamp. proficient in
						numerous languages and technologies. Game dev on the side.
					</p>
				</div>
			...
			>
				...
				<div className="col-lg-3 col-sm-12 text-end" id="header-projects">
					<h1>Projects</h1>
					<h2 className="mt-3 mb-3">Check out my work</h2>
					<p id="header-bio">
						Projects created during bootcamp as well as some passion projects.
					</p>
				</div>
			</div>
